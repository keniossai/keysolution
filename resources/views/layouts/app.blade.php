...
<head>
<meta charset="utf-8">
<title>KEYSOLUTIONS| Locksmith, Alarm System & Security Experts</title>
<!-- Stylesheets -->
    	...
    	<div class="header-top">
    		<div class="auto-container">
				<div class="clearfix">
					<!--Top Left-->
					<div class="top-left">
						<div class="text">Welcome to Key Solutions Locksmith Experts</div>
					</div>
					<!--Top Right-->
					<div class="top-right">
						<!--Social Box-->
        	...
        	<div class="auto-container">
            	<div class="clearfix">
                	...
                	<div class="pull-left logo-box">
                    	<div class="logo"><a href="index.html"><img src="images/logo 3.svg" alt="" title=""></a></div>
                    </div>
                    ...
                    <div class="pull-right upper-right clearfix">
                        ...
                        <div class="upper-column info-box">
                            ...
                            <ul>
								<li>8:00am to 6:00pm <br> Sunday Closed</li>
                            </ul>
                        </div>
                            ...
                            <ul class="navigation clearfix">
								...
								<li class="dropdown"><a href="#">Services</a>
									<ul>
										...
										<li><a href="moving-mouse.html">Moving Mouse</a></li>
										<li><a href="locks-change.html">Locks Changed</a></li>
										<li><a href="windows-doors.html">uPVC Windows and Doors</a></li>
        ...
        <div class="sticky-header">
        	<div class="auto-container clearfix">
            	...
            	<div class="logo pull-left">
                	<a href="index.html" class="img-responsive"><img src="images/logo 3.svg" alt="" title=""></a>
                </div>
						...
						<div class="footer-column col-lg-4 col-md-6 col-sm-12">
							...
							<div class="footer-widget links-widget">
								...
								<div class="row clearfix">
									...
									<ul class="link-list col-md-6 col-sm-6 col-xs-12">
										<li><a href="#">Locksmith Advice</a></li>
					...
					<div class="row clearfix">
						...
						<div class="info-block col-md-4 col-sm-6 col-xs-12">
							<div class="inner">
								...
								<h6>Address</h6>
								<div class="text">4 West 31st Street New York, New York - 10001 United States</div>
							</div>
						</div>
						...
						<div class="info-block col-md-4 col-sm-6 col-xs-12">
							<div class="inner">
								...
								<h6>Call Us On</h6>
								<div class="text">Front Desk: +45 423 445 99 / +45 423 445 99</div>
							</div>
						</div>
						...
						<div class="info-block col-md-4 col-sm-6 col-xs-12">
							<div class="inner">
								...
								<h6>Email at</h6>
								<div class="text">support@keysolutions.com</div>
							</div>
						</div>
